...
class TeslaFlagsSP(IntFlag):
  ...
  # Pre-AP boot-frozen hardware. Do not reuse HAS_VEHICLE_BUS for Pre-AP.
  PREAP_PEDAL_PRESENT = 32
  PREAP_RADAR_PRESENT = 64
  PREAP_RADAR_NOSECONE = 128
  PREAP_PEDAL_CALIB_AVAILABLE = 256
  PREAP_PEDAL_BUS_ZERO = 512
  PREAP_HANDS_ON_PAUSE = 1024
